...
# FastAPI의 Depends를 사용하면 with문을 사용하는 것 보다 더 간단하게 사용
# 객체에는 db.session 제너레이터에 의해 생성된 세션 객체가 주입된다. 이 때 session 함수에 자동으로 contextmanager가 적용
